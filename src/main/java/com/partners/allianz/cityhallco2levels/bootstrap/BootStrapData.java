...
public class BootStrapData implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        District district3 = new District("Hadapsar", carbonSensor3.getSensorData(), city.getId());
        city.getDistricts().add(district3);
        carbonSensor3.setDistricts(district3);

        CarbonSensor carbonSensor4 = new CarbonSensor("West", "36Kg");
        District district4 = new District("Kharadi", carbonSensor4.getSensorData(), city.getId());
